...
"""Const that represent the expected bake time of the lasagna.
"""

def bake_time_remaining(elapsed_bake_time):
    """Function that returns the remaining lasagna baking time according to the time already passed.

    :param elapsed _bake_time: int the minutes already passed.
    """
    
    return EXPECTED_BAKE_TIME - elapsed_bake_time

def preparation_time_in_minutes(number_of_layers):
    """Function that returns the preparation time based on the number of layers of the lasagna

    :param number_of_layers: int lasagna layers number.
    """
    return number_of_layers * 2

def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    """Function that returns the total number of minutes spent, both preparation and baking
    
    :param number_of_layers: int lasagna layers number.
    :param elapsed_bake_time: int the minutes already passed.
    """
